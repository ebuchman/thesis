...
\restylefloat{figure}
\begin{figure}[]
	\input{figures/data_structures.tex}
...
\begin{figure}[]
	\input{figures/consensus_rules.tex}
	\label{fig:tendermint_summary}
\end{figure}

\begin{figure}[]
	\input{figures/safety_guarantees.tex}
	\label{fig:tendermint_guarantees}
\end{figure}

\begin{figure}[]
	\input{figures/security_guarantees.tex}
...
\begin{figure}[]
	\input{figures/block_header.tex}
	\label{fig:header}
\end{figure}
