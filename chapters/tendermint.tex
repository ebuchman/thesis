...
(more than two-thirds pre-voting for a single block) at a round greater than that at which it locked.
...
\emph{propose}, \emph{prevote}, \emph{pre-commit}.
...
namely $propose_i$, $prevote_i$, and $pre-commit_i$,
