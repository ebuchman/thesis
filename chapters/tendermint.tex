...
\restylefloat{figure}
\begin{figure}[]
	\input{figures/descriptions/data_structures.tex}
...
\begin{figure}[]
	\input{figures/descriptions/consensus_rules.tex}
	\label{fig:tendermint_summary}
\end{figure}

\begin{figure}[]
	\input{figures/descriptions/safety_guarantees.tex}
	\label{fig:tendermint_guarantees}
\end{figure}

\begin{figure}[]
	\input{figures/descriptions/security_guarantees.tex}
