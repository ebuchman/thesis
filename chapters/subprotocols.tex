...
A common approach to securely gossipping data, as popularized by various p2p protocols \cite{bittorrent,libswift}, 
...
in order to minimize the bandwidth wasted by transmitting the same chunk to the a node more than once.
