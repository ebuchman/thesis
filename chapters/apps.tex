...
A list of message types, there arguments, return values, and purpose is given in \ref{fig:tmsp_msgs},
and an overview of the architecture and message flow is shown in \ref{fig:tmsp}.
