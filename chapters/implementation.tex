...
Given the apparent unlawfulness of such agencies, as made evident, for instance, by Edward Snowden,
...
Go provides an implementation of its extended library. RIPEMD160 is also used as one of two hashing functions by Bitcoin in the derivation of addresses from public keys.
...
The implementation of Tendermint in Golang takes advantage of the language's concurrency primitives, garbage collection, 
