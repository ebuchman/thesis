...
Tendermint also provides a self-balancing, merklized binary tree, modelled after the AVL tree \cite{avl}, as a tmsp service called merkleeyes.
...
The same API is available via three methods: GET requests using URI encoded paramters, POST requests using the JSONRPC standard \cite{jsonrpc}, 
