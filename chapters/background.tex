...
such that it functions as a single state machine despite the failure of some nodes \cite{state_machine}.
...
One of the most useful primitives in such a context is \emph{reliable broadcast}.
...
The purpose of a fault-tolerant distributed consensus system is to co-ordinate 
